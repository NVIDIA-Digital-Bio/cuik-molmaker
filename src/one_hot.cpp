...
size_t get_one_hot_atom_feature_size(AtomOneHotFeature feature) {
    ...
    case AtomOneHotFeature::ATOMIC_NUM_COMMON: return atomicNumCommonCount + 1;
    case AtomOneHotFeature::ATOMIC_NUM_ORGANIC: return atomicNumOrganicCount + 1;
    case AtomOneHotFeature::DEGREE:           return degreeCount + 1;
    case AtomOneHotFeature::TOTAL_DEGREE:     return totalDegreeCount + 1;
    ...
    case AtomOneHotFeature::HYBRIDIZATION_EXPANDED: return hybridizationExpandedCount + 1;
    case AtomOneHotFeature::HYBRIDIZATION_ORGANIC: return hybridizationOrganicCount + 1;
    case AtomOneHotFeature::CHIRALITY:        return chiralityCount + 1;
