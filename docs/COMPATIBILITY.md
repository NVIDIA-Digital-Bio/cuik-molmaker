...
| [NVIDIA PyPI](https://pypi.nvidia.com/rdkit-2026.03.4/cuik-molmaker/)                    | `cuik_molmaker`     | cuik-molmaker semantic version | You use RDKit from PyPI and you want a specific semantic version of `cuik-molmaker`. |
...
| cuik-molmaker | RDKit builds                                                                | Linux x86_64                 | macOS x86_64                 | Windows x86_64               |
| ------------- | --------------------------------------------------------------------------- | ---------------------------- | ---------------------------- | ---------------------------- |
...
| Pin / RDKit version | Linux x86_64           | macOS x86_64     | macOS arm64                           | Windows x86_64         |
| ------------------- | ---------------------- | ---------------- | ------------------------------------- | ---------------------- |
...
```bash
python -m pip install "cuik-molmaker-pin==2026.3.4"
```
...
| NVIDIA PyPI subdirectory                                                  | cuik-molmaker | Linux x86_64           | macOS x86_64     | macOS arm64            | Windows x86_64         |
| ------------------------------------------------------------------------- | ------------- | ---------------------- | ---------------- | ---------------------- | ---------------------- |
...
For example, to install `cuik-molmaker` `0.3.0` compatible with `rdkit-2026.03.4`, use the following command:

```bash
python -m pip install "cuik-molmaker==0.3.0" --extra-index-url https://pypi.nvidia.com/rdkit-2026.03.4/
```
